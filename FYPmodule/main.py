...
Integrates MediaPipe FaceMesh, YOLOv8 Pose, and OpenCV for multi-modal cheat detection
"""
...
# from ultralytics import YOLO  # Removed for performance optimization
import math
import time

app = FastAPI(title="AI Proctor API")
...
try:
    ...
    print(f"Warning: YOLO not loaded - device detection disabled: {e}")
    yolo_model = None
