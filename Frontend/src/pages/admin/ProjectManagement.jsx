              ...
              <div className="bg-white rounded-xl p-4 sm:p-6 hover:bg-surface-750 transition-all duration-300">
                <div className="flex flex-col lg:flex-row justify-between items-start gap-3 sm:gap-4">
                  ...
                  <div className="flex-1">
                    <div className="mb-3">
                      <h3 className="text-lg sm:text-xl font-semibold text-text-[rgb(15,23,42)]">{project.title}</h3>
                      <p className="text-[rgb(37,99,235)] text-sm mt-1 capitalize">{project.difficulty}</p>
                    </div>
                    ...
                    <div className="space-y-2 mb-3 sm:mb-4">
                      <div className="text-text-light text-xs sm:text-sm">
                        <span className="font-medium text-[rgb(37,99,235)]">Technologies: </span>
                        <span>{project.technologies?.join(', ') || 'Not specified'}</span>
                      </div>
                      <div className="text-text-light text-xs sm:text-sm">
                        <span className="font-medium text-[rgb(37,99,235)]">Prerequisites: </span>
